...
class DoaKeseharian extends StatefulWidget {
  ...
  const DoaKeseharian({super.key, String? userId, this.enableCrud = false})
    : userId = userId ?? 'guest';
...
class _DoaKeseharianState extends State<DoaKeseharian> {
  ...
  void initState() {
    super.initState();
    _prefsKey = 'doa_keseharian_checked_${widget.userId}';
    _itemsFuture = _loadItems();
  }

  Future<List<ModelBacaan>> _loadItems() async {
    final items = await readJsonData();
    _contentKey = 'doa_keseharian_content_${widget.userId}';
